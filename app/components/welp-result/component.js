...
var dispatchToActions = (dispatch) => {
  return {
    rate: (id, rating) => dispatch({type: 'RATE_ITEM_EPIC', payload: {id: id, rating: rating}}),
    comment: (id, comment) => dispatch({type: 'COMMENT_ITEM_EPIC', payload: {id: id, comment: comment}})
  };
};
