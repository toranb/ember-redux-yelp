...
test('rate should parse fetch response and merge payload with new rating', function(assert) {
  ...
  const result = reducer(previous, {type: 'RATE_ITEM', payload: {response: {result: {id: 2, name: 'two', reviews: [{id: 9, rating: 3, comment: 'decent'}]}}}});
...
test('comment should parse fetch response and merge payload with new comment', function(assert) {
  ...
  const result = reducer(previous, {type: 'COMMENT_ITEM', payload: {response: {result: {id: 2, name: 'two', reviews: [{id: 9, rating: 3, comment: 'decent'}]}}}});
